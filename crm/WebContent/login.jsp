											...
											<TD><s:actionerror />
												<TABLE cellSpacing=0 cellPadding=2 border=0>
													<TBODY>
														...
														<TR>
															<TD></TD>
															<TD><INPUT id=btn style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px" onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("btn", "", true, "", "", false, false))' type=image src="images/login_button.gif" name=btn> <input type="button" value="注册" onclick="registUI()" /></TD>
														</TR>
													</TBODY>
												</TABLE></TD>
										</TR>
